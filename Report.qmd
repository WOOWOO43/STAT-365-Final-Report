...
execute: 
  ...
  warning: false
abstract: |
  In this study, we investigated the factors affecting the frequency of appearances of X-Men characters in comic books published between 1963 and 1992. Our analysis centered on a dataset featuring 26 prominent characters, analyzing 44 variables per character, including appearance counts, demographic details, and estimated financial values. Employing statistical techniques such as linear regression, we identified significant predictors of character visibility, notably a character's estimated monetary value. Our findings contribute to understanding the dynamics of character utilization in serialized media, highlighting the impact of profitability on character prominence.
...
## Introduction {#intro}
The iconic X-Men series, which debuted in 1963, features a cast of characters whose appearances in comic books are influenced by a variety of factors. This report investigates these influences by analyzing data spanning three decades, from 1963 to 1992. Compiled by Anderson Evans from the Marvel Fandom Database, the dataset includes comprehensive metrics such as appearance frequencies, financial estimations, and demographic information for 26 characters. Through this study, we aimed to elucidate the factors that significantly affect how often these characters appear in comic books, with a particular focus on the role of profitability. We applied several statistical methods, including linear regression, to determine which variables most significantly predict character appearances. The analysis, results, and implications are detailed in the subsequent sections, providing a clearer understanding of how financial considerations impact character visibility in the X-Men series.
